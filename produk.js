const products = [
    ...
    { 
        ...
        price: 14999000, stock: 8, grade: 'Baru', sku: '7PZ3X8QA', sold: 312, berat: 2240,
        ...
        description: {
            ...
            specs: ['Garansi: Resmi iBox Official',
                    'Chip: Apple M4 (10-core CPU, 8-core GPU)', 
    ...
    { 
        ...
        price: 14999000, stock: 3, grade: 'Baru', sku: 'R4K81NZB',  sold: 163, berat: 2240,
    ...
    { 
        ...
        price: 18999000, stock: 5, grade: 'Baru', sku: 'G7X23MLQ',  sold: 232, berat: 2510,
        ...
        description: {
            intro: 'MacBook Air is the world’s most popular laptop for a reason’s. It delivers up to 18 hours of battery life. The M4 chip unlocks a whole new level of performance for work and play. And it now comes in a stunning Sky Blue color.',
            specs: ['Garansi: Resmi iBox Official','Chip: Apple M4 (10-core CPU, 10-core GPU)', 
    ...
    { 
        ...
        price: 18999000, stock: 6, grade: 'Baru', sku: '9HFZ3Y2A',  sold: 263, berat: 2510,
    ...
    { 
        ...
        price: 23499000, stock: 2, grade: 'Baru', sku: 'W1B8PZ6K', sold: 112, berat: 2550,
        ...
        description: {
            ...
            specs: ['Garansi: Resmi iBox Official','Chip: Apple M4 (10-core CPU, 10-core GPU, 16-core Neural Engine)', 
    ...
    { 
        ...
        price: 30399000, stock: 7, grade: 'Baru', sku: 'YZ93LMX4',  sold: 153, berat: 2610,
        ...
        description: {
            intro: 'MacBook Pro features the most advanced lineup of chips ever built for a pro laptop. Phenomenal single- and multithreaded CPU performance, faster unified memory, enhanced machine learning accelerators — the M4 family of chips gives you the kind of speed and capability you’ve never thought possible.',
            specs: ['Garansi: Resmi iBox Official','Chip: Apple M4 Pro (12‑core CPU, 16‑core GPU, 16‑core Neural Engine)', 
                    'Layar: 14-inch Liquid Retina XDR display',
    ...
    { 
        ...
        price: 48999000, stock: 6, grade: 'Baru', sku: 'KQ7AZ813',  sold: 112, berat: 2610,
        ...
        description: {
            intro: 'MacBook Pro features the most advanced lineup of chips ever built for a pro laptop. Phenomenal single- and multithreaded CPU performance, faster unified memory, enhanced machine learning accelerators — the M4 family of chips gives you the kind of speed and capability you’ve never thought possible.',
            specs: ['Garansi: Resmi iBox Official','Chip: Apple M4 Max (14‑core CPU, 32‑core GPU, 16‑core Neural Engine)', 
                    'Layar: 14-inch Liquid Retina XDR display',
    ...
    { 
        ...
        price: 38799000, stock: 7, grade: 'Baru', sku: '6NVB4XPQ',  sold: 201, berat: 3140,
        ...
        description: {
            intro: 'MacBook Pro features the most advanced lineup of chips ever built for a pro laptop. Phenomenal single- and multithreaded CPU performance, faster unified memory, enhanced machine learning accelerators — the M4 family of chips gives you the kind of speed and capability you’ve never thought possible.',
            specs: ['Garansi: Resmi iBox Official','Chip: Apple M4 Pro (14‑core CPU, 20‑core GPU, 16‑core Neural Engine)', 
    ...
    { 
        ...
        price: 53799000, stock: 4, grade: 'Baru', sku: 'M29XQY8L',  sold: 142, berat: 3150,
    ...
    { 
        ...
        price: 13999000, stock: 11, grade: 'Baru', sku: 'AXZL5NQ7',  sold: 117, berat: 2240,
        ...
        description: {
            ...
            specs: ['Garansi: Resmi iBox Official','Chip: Apple M3 (8-core CPU, 8-core GPU)', 
                    'Layar: 13.6-inch Liquid Retina display with True Tone',
                    'Memori: 16GB RAM terpadu', 
                    'Penyimpanan: 256GB SSD',
                    'Camera: 12MP Center Stage camera',
    ...
    { 
        ...
        price: 5600000, stock: 3, grade: 'A', sku: '7CCF0VDG',  sold: 72, berat: 2830,
    ...
    { 
        ...
        price: 8100000, stock: 6, grade: 'A', sku: '7CLL02GD',  sold: 32, berat: 2290,
    ...
    { 
        ...
        price: 9000000, stock: 4, grade: 'A', sku: '7RCF3DWH',  sold: 58, berat: 2400,
    ...
    { 
        ...
        price: 8000000, stock: 5, grade: 'A', sku: '7CLL1HBK',  sold: 80, berat: 2290,
    ...
    { 
        ...
        price: 5750000, stock: 3, grade: 'A', sku: 'OMOTA0GR',  sold: 41, berat: 2830,
    ...
    { 
        ...
        price: 6300000, stock: 6, grade: 'A', sku: '7CTH4QBL',  sold: 29, berat: 2370,
    ...
    { 
        ...
        price: 15300000, stock: 4, grade: 'A', sku: '7RHAEOWD',  sold: 65, berat: 2600,
    ...
    { 
        ...
        price: 7800000, stock: 2, grade: 'B', sku: 'OMHA9TBL',  sold: 47, berat: 2290,
    ...
    { 
        ...
        price: 6400000, stock: 3, grade: 'A', sku: '7RLLD8WO',  sold: 37, berat: 2370,
    ...
    { 
        ...
        price: 8250000, stock: 5, grade: 'A', sku: '7CHKJ1TP',  sold: 76, berat: 2290,
    ...
    { 
        ...
        price: 6300000, stock: 2, grade: 'A', sku: 'OMHZR7YL',  sold: 59, berat: 2830,
    ...
    { 
        ...
        price: 6600000, stock: 4, grade: 'A', sku: '7RHADMTP',  sold: 28, berat: 2830,
    ...
    { 
        ...
        price: 5200000, stock: 0, grade: 'B', sku: '7ROT12BK', sold: 84, berat: 2580,
    ...
    { 
        ...
        price: 5100000, stock: 3, grade: 'A', sku: '7RCF3EBK',  sold: 34, berat: 2830,
    ...
    { 
        ...
        price: 5200000, stock: 3, grade: 'A', sku: '7RHX3GBK',  sold: 69, berat: 2250,
    ...
    { 
        ...
        price: 6900000, stock: 4, grade: 'A', sku: 'OMHZR7BR',  sold: 53, berat: 2830,
    ...
    { 
        ...
        price: 6300000, stock: 4, grade: 'A', sku: '7RCF3DBK',  sold: 62, berat: 2290,
    ...
    { 
        ...
        price: 7300000, stock: 5, grade: 'A', sku: '7CHKCYBK',  sold: 45, berat: 2830,
    ...
    { 
        ...
        price: 4800000, stock: 0, grade: 'A', sku: 'OMHA44BK',  sold: 77, berat: 2370,
    ...
    { 
        ...
        price: 5100000, stock: 2, grade: 'A', sku: 'OMLL6QWT',  sold: 39, berat: 2370,
    ...
    { 
        ...
        price: 5750000, stock: 1, grade: 'A', sku: '7RHASNGR',  sold: 25, berat: 2250,
    ...
    { 
        ...
        price: 2100000, stock: 0, grade: 'B', sku: '7RLLD8WH', sold: 22, berat: 2350,
    ...
    { 
        ...
        price: 11200000, stock: 4, grade: 'A', sku: 'L9CF01BK',  sold: 51, berat: 2240,
    ...
    { 
        ...
        price: 6800000, stock: 2, grade: 'A', sku: '7RCF3ESV',  sold: 66, berat: 2290,
    ...
    // Tambahkan atau ganti produk iPhone Anda dengan struktur baru ini di dalam produk.js
        ...
        variants: [
                { sku: 'IP16PM-DT-256', color: 'Desert Titanium', colorHex: '#C3AA97', storage: '256GB', priceModifier: 0, stock: 8, sold: 159 },
                { sku: 'IP16PM-DT-512', color: 'Desert Titanium', colorHex: '#C3AA97', storage: '512GB', priceModifier: 4300000, stock: 12, sold: 250 },
                { sku: 'IP16PM-NT-256', color: 'Natural Titanium', colorHex: '#8A8A85', storage: '256GB', priceModifier: 0, stock: 4, sold: 231 },
                { sku: 'IP16PM-NT-512', color: 'Natural Titanium', colorHex: '#8A8A85', storage: '512GB', priceModifier: 4300000, stock: 6, sold: 189 },
                { sku: 'IP16PM-WT-256', color: 'White Titanium', colorHex: '#F3F1EE', storage: '256GB', priceModifier: 0, stock: 11, sold: 148 },
                { sku: 'IP16PM-WT-512', color: 'White Titanium', colorHex: '#F3F1EE', storage: '512GB', priceModifier: 4300000, stock: 2, sold: 116 },
                { sku: 'IP16PM-BT-256', color: 'Black Titanium', colorHex: '#474747', storage: '256GB', priceModifier: 0, stock: 9, sold: 263 },
                { sku: 'IP16PM-BT-512', color: 'Black Titanium', colorHex: '#474747', storage: '512GB', priceModifier: 4300000, stock: 13, sold: 124 },
        ],
        description: { 
            intro: 'iPhone 16 Pro Max. Ditempa dalam titanium dan menampilkan Chip A18 Pro terobosan, tombol Tindakan yang dapat disesuaikan, dan sistem kamera Pro paling kuat yang pernah ada di iPhone dengan zoom optik 5x.',
            specs: ['Garansi: Resmi iBox Official',
                'Layar: 6.9-inch Super Retina XDR dengan ProMotion',
                'Chip: A18 Pro dengan 6-core CPU, 6-core GPU, 16-core Neural Engine',
                'Kamera: Sistem kamera Pro 48MP (Utama) dengan 5x Telephoto',
                'Konektivitas: USB-C dengan kecepatan USB 3',
                'Fitur: Dynamic Island, Tombol Tindakan, Ceramic Shield'
            ]
        },
        ...
        name: 'iPhone 16 Pro',
        kategori: 'iPhone',
        basePrice: 16799000, // Harga untuk varian paling dasar
        berat: 449,
        images: {
        ...
        variants: [
                { sku: 'IP16PRO-DT-128', color: 'Desert Titanium', colorHex: '#C3AA97', storage: '128GB', priceModifier: 0, stock: 5, sold: 304 },
                { sku: 'IP16PRO-DT-256', color: 'Desert Titanium', colorHex: '#C3AA97', storage: '256GB', priceModifier: 2500000, stock: 1, sold: 227 },
                { sku: 'IP16PRO-DT-512', color: 'Desert Titanium', colorHex: '#C3AA97', storage: '512GB', priceModifier: 6000000, stock: 10, sold: 273 },
                { sku: 'IP16PRO-NT-128', color: 'Natural Titanium', colorHex: '#8A8A85', storage: '128GB', priceModifier: 0, stock: 13, sold: 229 },
                { sku: 'IP16PRO-NT-256', color: 'Natural Titanium', colorHex: '#8A8A85', storage: '256GB', priceModifier: 2500000, stock: 0, sold: 278 },
                { sku: 'IP16PRO-NT-512', color: 'Natural Titanium', colorHex: '#8A8A85', storage: '512GB', priceModifier: 6000000, stock: 9, sold: 263 },
                { sku: 'IP16PRO-WT-128', color: 'White Titanium', colorHex: '#F3F1EE', storage: '128GB', priceModifier: 0, stock: 3, sold: 313 },
                { sku: 'IP16PRO-WT-256', color: 'White Titanium', colorHex: '#F3F1EE', storage: '256GB', priceModifier: 2500000, stock: 15, sold: 167 },
                { sku: 'IP16PRO-WT-512', color: 'White Titanium', colorHex: '#F3F1EE', storage: '512GB', priceModifier: 6000000, stock: 6, sold: 172 },
                { sku: 'IP16PRO-BT-128', color: 'Black Titanium', colorHex: '#474747', storage: '128GB', priceModifier: 0, stock: 2, sold: 293 },
                { sku: 'IP16PRO-BT-256', color: 'Black Titanium', colorHex: '#474747', storage: '256GB', priceModifier: 2500000, stock: 11, sold: 176 },
                { sku: 'IP16PRO-BT-512', color: 'Black Titanium', colorHex: '#474747', storage: '512GB', priceModifier: 6000000, stock: 14, sold: 142 },
                ],
        // Deskripsi umum untuk produk ini
        description: { 
            intro: 'iPhone 16 Pro. Ditempa dalam titanium dan menampilkan Chip A18 Pro terobosan, tombol Tindakan yang dapat disesuaikan, dan sistem kamera Pro yang lebih kuat.',
            specs: ['Garansi: Resmi iBox Official',
                'Layar: 6.3-inch Super Retina XDR dengan ProMotion',
                'Chip: A18 Pro dengan 6-core CPU, 6-core GPU, 16-core Neural Engine',
                'Kamera: Sistem kamera Pro 48MP (Utama) dengan 3x Telephoto',
                'Konektivitas: USB-C dengan kecepatan USB 3',
                'Fitur: Dynamic Island, Tombol Tindakan, Ceramic Shield'
            ]
        },
        ...
        variants: [
                { sku: 'IP16-UM-128', color: 'Ultramarine', colorHex: '#A3B6F7', storage: '128GB', priceModifier: 0, stock: 2, sold: 337 },
                { sku: 'IP16-UM-256', color: 'Ultramarine', colorHex: '#A3B6F7', storage: '256GB', priceModifier: 2400000, stock: 15, sold: 343 },
                { sku: 'IP16-UM-512', color: 'Ultramarine', colorHex: '#A3B6F7', storage: '512GB', priceModifier: 4000000, stock: 11, sold: 264 },
                { sku: 'IP16-TE-128', color: 'Teal', colorHex: '#B5D7D5', storage: '128GB', priceModifier: 0, stock: 1, sold: 301 },
                { sku: 'IP16-TE-256', color: 'Teal', colorHex: '#B5D7D5', storage: '256GB', priceModifier: 2400000, stock: 14, sold: 315 },
                { sku: 'IP16-TE-512', color: 'Teal', colorHex: '#B5D7D5', storage: '512GB', priceModifier: 4000000, stock: 3, sold: 252 },
                { sku: 'IP16-PI-128', color: 'Pink', colorHex: '#F4B2DC', storage: '128GB', priceModifier: 0, stock: 7, sold: 381 },
                { sku: 'IP16-PI-256', color: 'Pink', colorHex: '#F4B2DC', storage: '256GB', priceModifier: 2400000, stock: 0, sold: 318 },
                { sku: 'IP16-PI-512', color: 'Pink', colorHex: '#F4B2DC', storage: '512GB', priceModifier: 4000000, stock: 8, sold: 288 },
                { sku: 'IP16-WH-128', color: 'White', colorHex: '#FAFAFA', storage: '128GB', priceModifier: 0, stock: 13, sold: 341 },
                { sku: 'IP16-WH-256', color: 'White', colorHex: '#FAFAFA', storage: '256GB', priceModifier: 2400000, stock: 9, sold: 305 },
                { sku: 'IP16-WH-512', color: 'White', colorHex: '#FAFAFA', storage: '512GB', priceModifier: 4000000, stock: 4, sold: 276 },
                { sku: 'IP16-BL-128', color: 'Black', colorHex: '#44474A', storage: '128GB', priceModifier: 0, stock: 5, sold: 392 },
                { sku: 'IP16-BL-256', color: 'Black', colorHex: '#44474A', storage: '256GB', priceModifier: 2400000, stock: 10, sold: 270 },
                { sku: 'IP16-BL-512', color: 'Black', colorHex: '#44474A', storage: '512GB', priceModifier: 4000000, stock: 12, sold: 289 },
        ],
        description: { 
            intro: 'iPhone 16. Didukung oleh Chip A18, sistem kamera ganda yang canggih untuk foto yang luar biasa dalam cahaya terang maupun rendah. Dan ketahanan baterai sepanjang hari.',
            specs: ['Garansi: Resmi iBox Official',
                'Layar: 6.1-inch Super Retina XDR',
                'Chip: A18 Bionic',
                'Kamera: Sistem kamera ganda 48MP (Utama) dan Ultra Wide',
                'Konektivitas: USB-C',
                'Fitur: Dynamic Island, Ceramic Shield'
            ]
        },
        ...
        // Produk 57 - iPhone 16e
        {
            ...
            variants: [
                { sku: 'IP16E-BK-128', color: 'Black', colorHex: '#41424c', storage: '128GB', priceModifier: 0, stock: 12, sold: 284 },
                { sku: 'IP16E-BK-256', color: 'Black', colorHex: '#41424c', storage: '256GB', priceModifier: 2200000, stock: 5, sold: 288 },
                { sku: 'IP16E-BK-512', color: 'Black', colorHex: '#41424c', storage: '512GB', priceModifier: 3500000, stock: 2, sold: 247 },
                { sku: 'IP16E-WH-128', color: 'White', colorHex: '#F9F6F1', storage: '128GB', priceModifier: 0, stock: 15, sold: 327 },
                { sku: 'IP16E-WH-256', color: 'White', colorHex: '#F9F6F1', storage: '256GB', priceModifier: 2200000, stock: 3, sold: 260 },
                { sku: 'IP16E-WH-512', color: 'White', colorHex: '#F9F6F1', storage: '512GB', priceModifier: 3500000, stock: 7, sold: 213 },
            ],
            description: { 
                intro: 'iPhone 16e. Dirancang untuk ekspresi diri dengan warna-warni cerah dan performa chip A18 yang andal untuk semua kebutuhan harian Anda. Abadikan setiap momen dengan sistem kamera ganda yang cerdas.',
                specs: ['Garansi: Resmi iBox Official','Layar: 6.1-inch Super Retina XDR', 'Chip: A18 dengan 6-core CPU dan 4-core GPU', 'Kamera Utama: 2-in-1 48MP Camera System', 'Konektor: USB-C', 'Baterai: Hingga 26 jam pemutaran video'],
            },
            pros: ['Pilihan warna klasik dan elegan', 'Chip A18 yang kencang dan efisien', 'Desain ringan dengan material ramah lingkungan', 'Layar Super Retina XDR yang jernih'],
            inTheBox: ['Unit iPhone 16e', 'Kabel Pengisi Daya USB-C (1 m)']
        },
        // Produk 58 - iPhone 15 Pro
        {
            id: 58,
            name: 'iPhone 15 Pro',
            kategori: 'iPhone',
            ...
            images: {
                ...
                'White Titanium': ['images/produk/id58_ip15p/ip15p-wt-1.webp'],
                'Black Titanium': ['images/produk/id58_ip15p/ip15p-blt-1.webp', 'images/produk/id58_ip15p/ip15p-blt-2.webp', 'images/produk/id58_ip15p/ip15p-blt-3.webp'],
            },
            variants: [
                { sku: 'IP15P-NT-128', color: 'Natural Titanium', colorHex: '#8A8A85', storage: '128GB', priceModifier: 0, stock: 12, sold: 325 },
                { sku: 'IP15P-NT-256', color: 'Natural Titanium', colorHex: '#8A8A85', storage: '256GB', priceModifier: 2500000, stock: 7, sold: 291 },
                { sku: 'IP15P-NT-512', color: 'Natural Titanium', colorHex: '#8A8A85', storage: '512GB', priceModifier: 5000000, stock: 3, sold: 211 },
                { sku: 'IP15P-BT-128', color: 'Blue Titanium', colorHex: '#2E435A', storage: '128GB', priceModifier: 0, stock: 9, sold: 314 },
                { sku: 'IP15P-BT-256', color: 'Blue Titanium', colorHex: '#2E435A', storage: '256GB', priceModifier: 2500000, stock: 5, sold: 284 },
                { sku: 'IP15P-BT-512', color: 'Blue Titanium', colorHex: '#2E435A', storage: '512GB', priceModifier: 5000000, stock: 0, sold: 212 },
                { sku: 'IP15P-WT-128', color: 'White Titanium', colorHex: '#F3F1EE', storage: '128GB', priceModifier: 0, stock: 10, sold: 309 },
                { sku: 'IP15P-WT-256', color: 'White Titanium', colorHex: '#F3F1EE', storage: '256GB', priceModifier: 2500000, stock: 8, sold: 287 },
                { sku: 'IP15P-WT-512', color: 'White Titanium', colorHex: '#F3F1EE', storage: '512GB', priceModifier: 5000000, stock: 2, sold: 236 },
                { sku: 'IP15P-BLT-128', color: 'Black Titanium', colorHex: '#474747', storage: '128GB', priceModifier: 0, stock: 6, sold: 329 },
                { sku: 'IP15P-BLT-256', color: 'Black Titanium', colorHex: '#474747', storage: '256GB', priceModifier: 2500000, stock: 13, sold: 273 },
                { sku: 'IP15P-BLT-512', color: 'Black Titanium', colorHex: '#474747', storage: '512GB', priceModifier: 5000000, stock: 11, sold: 240 },
            ],
            description: { 
                intro: 'iPhone 15 Pro. Ditempa dengan titanium sekelas dirgantara. Mengubah permainan dengan chip A17 Pro, Tombol Tindakan yang dapat disesuaikan, dan sistem kamera Pro paling serbaguna.',
                specs: ['Garansi: Resmi iBox Official','Layar: 6.1-inch Super Retina XDR dengan ProMotion', 'Chip: A17 Pro dengan 6-core CPU dan 6-core GPU', 'Kamera Utama: 48MP dengan sensor quad-pixel', 'Kamera Telefoto: 12MP dengan zoom optik 3x', 'Konektor: USB-C dengan dukungan USB 3', 'Baterai: Hingga 23 jam pemutaran video'],
            },
            pros: ['Material titanium yang kuat namun ringan', 'Performa grafis setara konsol dengan Chip A17 Pro', 'Kamera utama 48MP dengan detail luar biasa', 'Tombol Tindakan untuk akses cepat ke fitur favorit'],
        ...
        variants: [
            { sku: 'IP15-BU-128', color: 'Blue', colorHex: '#D6DDE0', storage: '128GB', priceModifier: 0, stock: 9, sold: 294 },
            { sku: 'IP15-BU-256', color: 'Blue', colorHex: '#D6DDE0', storage: '256GB', priceModifier: 2100000, stock: 13, sold: 291 },
            { sku: 'IP15-BU-512', color: 'Blue', colorHex: '#D6DDE0', storage: '512GB', priceModifier: 4100000, stock: 1, sold: 233 },

            { sku: 'IP15-PI-128', color: 'Pink', colorHex: '#ECD1D2', storage: '128GB', priceModifier: 0, stock: 15, sold: 325 },
            { sku: 'IP15-PI-256', color: 'Pink', colorHex: '#ECD1D2', storage: '256GB', priceModifier: 2100000, stock: 3, sold: 263 },
            { sku: 'IP15-PI-512', color: 'Pink', colorHex: '#ECD1D2', storage: '512GB', priceModifier: 4100000, stock: 4, sold: 222 },

            { sku: 'IP15-YE-128', color: 'Yellow', colorHex: '#EEE8CD', storage: '128GB', priceModifier: 0, stock: 8, sold: 319 },
            { sku: 'IP15-YE-256', color: 'Yellow', colorHex: '#EEE8CD', storage: '256GB', priceModifier: 2100000, stock: 0, sold: 283 },
            { sku: 'IP15-YE-512', color: 'Yellow', colorHex: '#EEE8CD', storage: '512GB', priceModifier: 4100000, stock: 5, sold: 207 },

            { sku: 'IP15-GR-128', color: 'Green', colorHex: '#D3DBCC', storage: '128GB', priceModifier: 0, stock: 10, sold: 282 },
            { sku: 'IP15-GR-256', color: 'Green', colorHex: '#D3DBCC', storage: '256GB', priceModifier: 2100000, stock: 7, sold: 274 },
            { sku: 'IP15-GR-512', color: 'Green', colorHex: '#D3DBCC', storage: '512GB', priceModifier: 4100000, stock: 2, sold: 210 },

            { sku: 'IP15-BL-128', color: 'Black', colorHex: '#4F5255', storage: '128GB', priceModifier: 0, stock: 6, sold: 306 },
            { sku: 'IP15-BL-256', color: 'Black', colorHex: '#4F5255', storage: '256GB', priceModifier: 2100000, stock: 14, sold: 251 },
            { sku: 'IP15-BL-512', color: 'Black', colorHex: '#4F5255', storage: '512GB', priceModifier: 4100000, stock: 0, sold: 221 },
            ],
        description: { 
            intro: 'iPhone 15. Dynamic Island hadir di iPhone 15. Kamera Utama 48 MP baru. Desain aluminium dan kaca yang diwarnai secara keseluruhan. Tahan cipratan, air, dan debu.',
            specs: ['Garansi: Resmi iBox Official',
                'Layar: 6.1-inch Super Retina XDR',
                'Chip: A16 Bionic',
                'Kamera: Sistem kamera ganda 48MP (Utama) dan Ultra Wide',
        ...
        // Produk 59 - iPhone 14 Pro
        {
            ...
            images: {
                ...
                'Silver': ['images/produk/id59_ip14p/ip14p-si-1.webp', 'images/produk/id59_ip14p/ip14p-si-2.webp', 'images/produk/id59_ip14p/ip14p-si-3.webp'],
                'Space Black': ['images/produk/id59_ip14p/ip14p-sb-1.webp'],
            },
            variants: [
                { sku: 'IP14P-DP-128', color: 'Deep Purple', colorHex: '#574f6f', storage: '128GB', priceModifier: 0, stock: 2, sold: 289 },
                { sku: 'IP14P-DP-256', color: 'Deep Purple', colorHex: '#574f6f', storage: '256GB', priceModifier: 1500000, stock: 12, sold: 257 },
                { sku: 'IP14P-DP-512', color: 'Deep Purple', colorHex: '#574f6f', storage: '512GB', priceModifier: 3000000, stock: 6, sold: 228 },

                { sku: 'IP14P-GO-128', color: 'Gold', colorHex: '#f5e1c8', storage: '128GB', priceModifier: 0, stock: 9, sold: 310 },
                { sku: 'IP14P-GO-256', color: 'Gold', colorHex: '#f5e1c8', storage: '256GB', priceModifier: 1500000, stock: 3, sold: 289 },
                { sku: 'IP14P-GO-512', color: 'Gold', colorHex: '#f5e1c8', storage: '512GB', priceModifier: 3000000, stock: 15, sold: 207 },

                { sku: 'IP14P-SI-128', color: 'Silver', colorHex: '#e3e4e6', storage: '128GB', priceModifier: 0, stock: 0, sold: 303 },
                { sku: 'IP14P-SI-256', color: 'Silver', colorHex: '#e3e4e6', storage: '256GB', priceModifier: 1500000, stock: 7, sold: 258 },
                { sku: 'IP14P-SI-512', color: 'Silver', colorHex: '#e3e4e6', storage: '512GB', priceModifier: 3000000, stock: 5, sold: 246 },

                { sku: 'IP14P-SB-128', color: 'Space Black', colorHex: '#3a3a3d', storage: '128GB', priceModifier: 0, stock: 14, sold: 278 },
                { sku: 'IP14P-SB-256', color: 'Space Black', colorHex: '#3a3a3d', storage: '256GB', priceModifier: 1500000, stock: 8, sold: 276 },
                { sku: 'IP14P-SB-512', color: 'Space Black', colorHex: '#3a3a3d', storage: '512GB', priceModifier: 3000000, stock: 1, sold: 211 },
            ],
            description: { 
                intro: 'iPhone 14 Pro. Memperkenalkan Dynamic Island, cara baru yang ajaib untuk berinteraksi dengan iPhone. Dilengkapi kamera utama 48 MP untuk detail yang menakjubkan dan layar yang Selalu Aktif.',
                specs: ['Garansi: Resmi iBox Official','Layar: 6.1-inch Super Retina XDR dengan ProMotion', 'Chip: A16 Bionic dengan 6-core CPU dan 5-core GPU', 'Kamera Utama: 48MP dengan sensor quad-pixel', 'Fitur: Dynamic Island, Layar Selalu Aktif', 'Konektor: Lightning', 'Baterai: Hingga 23 jam pemutaran video'],
            },
            pros: ['Dynamic Island untuk notifikasi dan aktivitas langsung', 'Layar Super Retina XDR yang Selalu Aktif', 'Performa super cepat dengan Chip A16 Bionic', 'Mode Sinematik kini dalam 4K Dolby Vision'],
            inTheBox: ['Unit iPhone 14 Pro', 'Kabel USB-C ke Lightning']
        },
        //produk 39
        {
            id: 39,
            ...
            variants: [
                    { sku: 'IP14-RE-128', color: 'Red', colorHex: '#FC0325', storage: '128GB', priceModifier: 0, stock: 5, sold: 289 },
                    { sku: 'IP14-RE-256', color: 'Red', colorHex: '#FC0325', storage: '256GB', priceModifier: 1500000, stock: 12, sold: 261 },
                    { sku: 'IP14-RE-512', color: 'Red', colorHex: '#FC0325', storage: '512GB', priceModifier: 3000000, stock: 3, sold: 225 },
                    { sku: 'IP14-BU-128', color: 'Blue', colorHex: '#A0B4C7', storage: '128GB', priceModifier: 0, stock: 15, sold: 312 },
                    { sku: 'IP14-BU-256', color: 'Blue', colorHex: '#A0B4C7', storage: '256GB', priceModifier: 1500000, stock: 8, sold: 288 },
                    { sku: 'IP14-BU-512', color: 'Blue', colorHex: '#A0B4C7', storage: '512GB', priceModifier: 3000000, stock: 0, sold: 241 },
                    { sku: 'IP14-PU-128', color: 'Purple', colorHex: '#E6DDEB', storage: '128GB', priceModifier: 0, stock: 7, sold: 295 },
                    { sku: 'IP14-PU-256', color: 'Purple', colorHex: '#E6DDEB', storage: '256GB', priceModifier: 1500000, stock: 11, sold: 255 },
                    { sku: 'IP14-PU-512', color: 'Purple', colorHex: '#E6DDEB', storage: '512GB', priceModifier: 3000000, stock: 4, sold: 217 },
                    { sku: 'IP14-YE-128', color: 'Yellow', colorHex: '#FAE479', storage: '128GB', priceModifier: 0, stock: 14, sold: 321 },
                    { sku: 'IP14-YE-256', color: 'Yellow', colorHex: '#FAE479', storage: '256GB', priceModifier: 1500000, stock: 9, sold: 274 },
                    { sku: 'IP14-YE-512', color: 'Yellow', colorHex: '#FAE479', storage: '512GB', priceModifier: 3000000, stock: 1, sold: 209 },
                    { sku: 'IP14-MD-128', color: 'Midnight', colorHex: '#222930', storage: '128GB', priceModifier: 0, stock: 6, sold: 303 },
                    { sku: 'IP14-MD-256', color: 'Midnight', colorHex: '#222930', storage: '256GB', priceModifier: 1500000, stock: 13, sold: 281 },
                    { sku: 'IP14-MD-512', color: 'Midnight', colorHex: '#222930', storage: '512GB', priceModifier: 3000000, stock: 2, sold: 251 },
                    { sku: 'IP14-SR-128', color: 'Starlight', colorHex: '#FAF6F2', storage: '128GB', priceModifier: 0, stock: 10, sold: 278 },
                    { sku: 'IP14-SR-256', color: 'Starlight', colorHex: '#FAF6F2', storage: '256GB', priceModifier: 1500000, stock: 5, sold: 250 },
                    { sku: 'IP14-SR-512', color: 'Starlight', colorHex: '#FAF6F2', storage: '512GB', priceModifier: 3000000, stock: 8, sold: 233 },
            ],
            description: { 
                intro: 'iPhone 14. Dengan sistem kamera ganda paling impresif di iPhone untuk foto menakjubkan dalam pencahayaan rendah maupun terang. Dan Deteksi Tabrakan, sebuah fitur keselamatan baru.',
                specs: ['Garansi: Resmi iBox Official','Layar: 6.1-inch Super Retina XDR', 'Chip: A15 Bionic dengan 5-core GPU', 'Kamera Utama: 12MP', 'Fitur: Deteksi Tabrakan', 'Konektor: Lightning', 'Baterai: Hingga 20 jam pemutaran video']
            },
        ...
        // Produk 60 - iPhone 13 Pro
        {
            ...
            images: {
                ...
                'Gold': ['images/produk/id60_ip13p/ip13p-go-1.webp'],
                'Silver': ['images/produk/id60_ip13p/ip13p-si-1.webp'],
            },
            variants: [
                { sku: 'IP13P-SB-128', color: 'Sierra Blue', colorHex: '#a7c1d9', storage: '128GB', priceModifier: 0, stock: 14, sold: 325 },
                { sku: 'IP13P-SB-256', color: 'Sierra Blue', colorHex: '#a7c1d9', storage: '256GB', priceModifier: 1500000, stock: 7, sold: 277 },
                { sku: 'IP13P-SB-512', color: 'Sierra Blue', colorHex: '#a7c1d9', storage: '512GB', priceModifier: 3000000, stock: 2, sold: 248 },
                { sku: 'IP13P-GR-128', color: 'Graphite', colorHex: '#5c5b57', storage: '128GB', priceModifier: 0, stock: 11, sold: 311 },
                { sku: 'IP13P-GR-256', color: 'Graphite', colorHex: '#5c5b57', storage: '256GB', priceModifier: 1500000, stock: 6, sold: 284 },
                { sku: 'IP13P-GR-512', color: 'Graphite', colorHex: '#5c5b57', storage: '512GB', priceModifier: 3000000, stock: 0, sold: 219 },
                { sku: 'IP13P-GO-128', color: 'Gold', colorHex: '#f5e1c8', storage: '128GB', priceModifier: 0, stock: 15, sold: 299 },
                { sku: 'IP13P-GO-256', color: 'Gold', colorHex: '#f5e1c8', storage: '256GB', priceModifier: 1500000, stock: 8, sold: 263 },
                { sku: 'IP13P-GO-512', color: 'Gold', colorHex: '#f5e1c8', storage: '512GB', priceModifier: 3000000, stock: 3, sold: 226 },
                { sku: 'IP13P-SI-128', color: 'Silver', colorHex: '#e3e4e6', storage: '128GB', priceModifier: 0, stock: 9, sold: 330 },
                { sku: 'IP13P-SI-256', color: 'Silver', colorHex: '#e3e4e6', storage: '256GB', priceModifier: 1500000, stock: 1, sold: 251 },
                { sku: 'IP13P-SI-512', color: 'Silver', colorHex: '#e3e4e6', storage: '512GB', priceModifier: 3000000, stock: 5, sold: 205 },
            ],
            description: { 
                intro: 'iPhone 13 Pro. Sebuah lompatan besar dalam sistem kamera Pro. Layar ProMotion yang terasa lebih cepat dan responsif. Chip A15 Bionic secepat kilat. Desain kokoh dan lompatan besar dalam kekuatan baterai.',
                specs: ['Garansi: Resmi iBox Official','Layar: 6.1-inch Super Retina XDR dengan ProMotion', 'Chip: A15 Bionic dengan 6-core CPU dan 5-core GPU', 'Kamera Utama: 12MP', 'Fitur: Layar ProMotion', 'Konektor: Lightning', 'Baterai: Hingga 22 jam pemutaran video'],
            },
            pros: ['Layar ProMotion untuk scrolling dan game yang super mulus', 'Peningkatan besar dalam fotografi cahaya rendah', 'Mode Sinematik untuk video berkualitas film', 'Daya tahan baterai yang luar biasa'],
            inTheBox: ['Unit iPhone 13 Pro', 'Kabel USB-C ke Lightning']
        },
        // Produk 61 - iPhone 13
        {
            id: 61,
            ...
            berat: 424,
            images: {
                'Green': ['images/produk/id61_ip13/ip13-gr-1.webp'],
                'Blue': ['images/produk/id61_ip13/ip13-bl-1.webp'],
                'Pink': ['images/produk/id61_ip13/ip13-pi-1.webp'],
                'Midnight': ['images/produk/id61_ip13/ip13-mi-1.webp'],
                'Starlight': ['images/produk/id61_ip13/ip13-st-1.webp'],
                'Red': ['images/produk/id61_ip13/ip13-re-1.webp'],
            },
            variants: [
                { sku: 'IP13-GR-128', color: 'Green', colorHex: '#526250', storage: '128GB', priceModifier: 0, stock: 9, sold: 315 },
                { sku: 'IP13-GR-256', color: 'Green', colorHex: '#526250', storage: '256GB', priceModifier: 1300000, stock: 4, sold: 288 },
                { sku: 'IP13-BL-128', color: 'Blue', colorHex: '#3d6d99', storage: '128GB', priceModifier: 0, stock: 12, sold: 294 },
                { sku: 'IP13-BL-256', color: 'Blue', colorHex: '#3d6d99', storage: '256GB', priceModifier: 1300000, stock: 7, sold: 259 },
                { sku: 'IP13-PI-128', color: 'Pink', colorHex: '#faddd7', storage: '128GB', priceModifier: 0, stock: 15, sold: 328 },
                { sku: 'IP13-PI-256', color: 'Pink', colorHex: '#faddd7', storage: '256GB', priceModifier: 1300000, stock: 8, sold: 271 },
                { sku: 'IP13-MI-128', color: 'Midnight', colorHex: '#41424c', storage: '128GB', priceModifier: 0, stock: 3, sold: 281 },
                { sku: 'IP13-MI-256', color: 'Midnight', colorHex: '#41424c', storage: '256GB', priceModifier: 1300000, stock: 0, sold: 253 },
                { sku: 'IP13-ST-128', color: 'Starlight', colorHex: '#f9f3ee', storage: '128GB', priceModifier: 0, stock: 11, sold: 307 },
                { sku: 'IP13-ST-256', color: 'Starlight', colorHex: '#f9f3ee', storage: '256GB', priceModifier: 1300000, stock: 6, sold: 265 },
                { sku: 'IP13-RE-128', color: 'Red', colorHex: '#FC0325', storage: '128GB', priceModifier: 0, stock: 10, sold: 319 },
                { sku: 'IP13-RE-256', color: 'Red', colorHex: '#FC0325', storage: '256GB', priceModifier: 1300000, stock: 2, sold: 290 },
            ],
            description: { 
                intro: 'iPhone 13. Sistem kamera ganda paling canggih yang pernah ada di iPhone. Chip A15 Bionic secepat kilat. Lompatan besar dalam kekuatan baterai. Desain kokoh. Dan layar Super Retina XDR yang lebih cerah.',
                specs: ['Garansi: Resmi iBox Official','Layar: 6.1-inch Super Retina XDR', 'Chip: A15 Bionic dengan 6-core CPU dan 4-core GPU', 'Kamera Utama: 12MP', 'Konektor: Lightning', 'Baterai: Hingga 19 jam pemutaran video'],
            },
            pros: ['Kamera ganda yang menghasilkan foto dan video luar biasa', 'Mode Sinematik membuat cerita Anda menjadi hidup', 'Performa super cepat untuk semua tugas', 'Daya tahan baterai sepanjang hari'],
            inTheBox: ['Unit iPhone 13', 'Kabel USB-C ke Lightning']
        },
        // Produk 62 - iPhone 12
        {
            id: 62,
            ...
            berat: 414,
            images: {
                'Purple': ['images/produk/id62_ip12/ip12-pu-1.webp'],
                'Blue': ['images/produk/id62_ip12/ip12-bu-1.webp'],
                'Green': ['images/produk/id62_ip12/ip12-gr-1.webp'],
                'White': ['images/produk/id62_ip12/ip12-wh-1.webp'],
                'Black': ['images/produk/id62_ip12/ip12-bk-1.webp'],
                'Red': ['images/produk/id62_ip12/ip12-re-1.webp'],
            },
            variants: [
                { sku: 'IP12-PU-64', color: 'Purple', colorHex: '#d8d1e8', storage: '64GB', priceModifier: 0, stock: 11, sold: 488 },
                { sku: 'IP12-PU-128', color: 'Purple', colorHex: '#d8d1e8', storage: '128GB', priceModifier: 800000, stock: 6, sold: 291 },
                { sku: 'IP12-PU-256', color: 'Purple', colorHex: '#d8d1e8', storage: '256GB', priceModifier: 1700000, stock: 2, sold: 264 },
                { sku: 'IP12-BU-64', color: 'Blue', colorHex: '#3d6d99', storage: '64GB', priceModifier: 0, stock: 15, sold: 501 },
                { sku: 'IP12-BU-128', color: 'Blue', colorHex: '#3d6d99', storage: '128GB', priceModifier: 800000, stock: 8, sold: 317 },
                { sku: 'IP12-BU-256', color: 'Blue', colorHex: '#3d6d99', storage: '256GB', priceModifier: 1700000, stock: 4, sold: 280 },
                { sku: 'IP12-GR-64', color: 'Green', colorHex: '#d9ead3', storage: '64GB', priceModifier: 0, stock: 13, sold: 450 },
                { sku: 'IP12-GR-128', color: 'Green', colorHex: '#d9ead3', storage: '128GB', priceModifier: 800000, stock: 9, sold: 305 },
                { sku: 'IP12-GR-256', color: 'Green', colorHex: '#d9ead3', storage: '256GB', priceModifier: 1700000, stock: 1, sold: 252 },
                { sku: 'IP12-WH-64', color: 'White', colorHex: '#f9f6f1', storage: '64GB', priceModifier: 0, stock: 10, sold: 399 },
                { sku: 'IP12-WH-128', color: 'White', colorHex: '#f9f6f1', storage: '128GB', priceModifier: 800000, stock: 5, sold: 283 },
                { sku: 'IP12-WH-256', color: 'White', colorHex: '#f9f6f1', storage: '256GB', priceModifier: 1700000, stock: 0, sold: 275 },
                { sku: 'IP12-BK-64', color: 'Black', colorHex: '#3d3d3d', storage: '64GB', priceModifier: 0, stock: 14, sold: 412 },
                { sku: 'IP12-BK-128', color: 'Black', colorHex: '#3d3d3d', storage: '128GB', priceModifier: 800000, stock: 7, sold: 329 },
                { sku: 'IP12-BK-256', color: 'Black', colorHex: '#3d3d3d', storage: '256GB', priceModifier: 1700000, stock: 3, sold: 290 },
                { sku: 'IP12-RE-64', color: 'Red', colorHex: '#DC4647', storage: '64GB', priceModifier: 0, stock: 12, sold: 515 },
                { sku: 'IP12-RE-128', color: 'Red', colorHex: '#DC4647', storage: '128GB', priceModifier: 800000, stock: 6, sold: 274 },
                { sku: 'IP12-RE-256', color: 'Red', colorHex: '#DC4647', storage: '256GB', priceModifier: 1700000, stock: 2, sold: 258 },
            ],
            description: { 
                intro: 'iPhone 12. Layar Super Retina XDR yang indah. Ceramic Shield dengan ketahanan jatuh empat kali lebih baik. Mode Malam di setiap kamera. Dan chip A14 Bionic, chip paling cepat di ponsel pintar.',
                specs: ['Garansi: Resmi iBox Official','Layar: 6.1-inch Super Retina XDR', 'Chip: A14 Bionic dengan 6-core CPU dan 4-core GPU', 'Kamera Utama: 12MP', 'Fitur: Ceramic Shield', 'Konektor: Lightning', 'Baterai: Hingga 17 jam pemutaran video'],
            },
            pros: ['Desain tepi datar yang ikonik dan modern', 'Layar OLED Super Retina XDR yang tajam', 'Perlindungan Ceramic Shield yang tangguh', 'Chip A14 Bionic yang memberikan performa hebat'],
            inTheBox: ['Unit iPhone 12', 'Kabel USB-C ke Lightning']
        },
    ...
    // produk 40
    {
        ...
        variants: [
            { sku: 'IPP13-SB-256', color: 'Space Black', colorHex: '#3a3a3d', storage: '256GB', priceModifier: 0, stock: 12, sold: 159 },
            { sku: 'IPP13-SB-512', color: 'Space Black', colorHex: '#3a3a3d', storage: '512GB', priceModifier: 3000000, stock: 8, sold: 115 },
            { sku: 'IPP13-SB-1TB', color: 'Space Black', colorHex: '#3a3a3d', storage: '1TB', priceModifier: 8000000, stock: 4, sold: 67 },
            { sku: 'IPP13-SB-2TB', color: 'Space Black', colorHex: '#3a3a3d', storage: '2TB', priceModifier: 11000000, stock: 2, sold: 22 },
            { sku: 'IPP13-SL-256', color: 'Silver', colorHex: '#e3e4e6', storage: '256GB', priceModifier: 0, stock: 14, sold: 170 },
            { sku: 'IPP13-SL-512', color: 'Silver', colorHex: '#e3e4e6', storage: '512GB', priceModifier: 3000000, stock: 9, sold: 131 },
            { sku: 'IPP13-SL-1TB', color: 'Silver', colorHex: '#e3e4e6', storage: '1TB', priceModifier: 8000000, stock: 3, sold: 45 },
            { sku: 'IPP13-SL-2TB', color: 'Silver', colorHex: '#e3e4e6', storage: '2TB', priceModifier: 11000000, stock: 0, sold: 15 },
        ],
        description: {
            ...
            specs: ['Garansi: Resmi iBox Official', 'Layar: Ultra Retina XDR 13 inci dengan ProMotion', 'Chip: Apple M4', 'Kamera: 12MP Wide, 10MP Ultra Wide', 'Konektor: USB-C dengan dukungan Thunderbolt / USB 4', 'Koneksi: Wifi Only' ],
        },
    ...
    // produk 41
    {
        ...
        variants: [
            { sku: 'IPP11-SI-256', color: 'Silver', colorHex: '#e3e4e6', storage: '256GB', priceModifier: 0, stock: 9, sold: 165 },
            { sku: 'IPP11-SI-512', color: 'Silver', colorHex: '#e3e4e6', storage: '512GB', priceModifier: 3000000, stock: 5, sold: 121 },
            { sku: 'IPP11-SI-1TB', color: 'Silver', colorHex: '#e3e4e6', storage: '1TB', priceModifier: 8000000, stock: 2, sold: 58 },
            { sku: 'IPP11-SI-2TB', color: 'Silver', colorHex: '#e3e4e6', storage: '2TB', priceModifier: 11000000, stock: 1, sold: 25 },
            { sku: 'IPP11-SB-256', color: 'Space Black', colorHex: '#3a3a3d', storage: '256GB', priceModifier: 0, stock: 11, sold: 153 },
            { sku: 'IPP11-SB-512', color: 'Space Black', colorHex: '#3a3a3d', storage: '512GB', priceModifier: 3000000, stock: 7, sold: 110 },
            { sku: 'IPP11-SB-1TB', color: 'Space Black', colorHex: '#3a3a3d', storage: '1TB', priceModifier: 8000000, stock: 4, sold: 77 },
            { sku: 'IPP11-SB-2TB', color: 'Space Black', colorHex: '#3a3a3d', storage: '2TB', priceModifier: 11000000, stock: 2, sold: 19 },
        ],
        description: {
            intro: 'iPad Pro. Tenaga luar biasa dengan layar paling canggih di dunia. Ditenagai chip Apple M4, iPad Pro baru menghadirkan performa menakjubkan dalam desain yang super tipis dan ringan.',
            specs: [ 'Garansi: Resmi iBox Official','Layar: Ultra Retina XDR 11 inci dengan ProMotion', 'Chip: Apple M4', 'Kamera: 12MP Wide, 10MP Ultra Wide', 'Konektor: USB-C dengan dukungan Thunderbolt / USB 4', 'Koneksi: Wifi Only'  ],
        },
        pros: ['Performa setara laptop dengan chip M4', 'Layar OLED Tandem terbaik di pasaran', 'Desain sangat tipis dan ringan', 'Mendukung Apple Pencil Pro dan Magic Keyboard baru'],
    ...
    // Produk 42 iPad Air 13" M3
    {
        ...
        variants: [
            { sku: 'IPA13-BU-128', color: 'Blue', colorHex: '#a5b8cc', storage: '128GB', priceModifier: 0, stock: 14, sold: 94 },
            { sku: 'IPA13-BU-256', color: 'Blue', colorHex: '#a5b8cc', storage: '256GB', priceModifier: 2100000, stock: 21, sold: 143 },
            { sku: 'IPA13-BU-512', color: 'Blue', colorHex: '#a5b8cc', storage: '512GB', priceModifier: 4200000, stock: 8, sold: 87 },
            { sku: 'IPA13-BU-1TB',  color: 'Blue', colorHex: '#a5b8cc', storage: '1TB', priceModifier: 8400000, stock: 20, sold: 52 },

            { sku: 'IPA13-SG-128', color: 'Space Grey', colorHex: '#5e5d5a', storage: '128GB', priceModifier: 0, stock: 12, sold: 132 },
            { sku: 'IPA13-SG-256', color: 'Space Grey', colorHex: '#5e5d5a', storage: '256GB', priceModifier: 2100000, stock: 16, sold: 171 },
            { sku: 'IPA13-SG-512', color: 'Space Grey', colorHex: '#5e5d5a', storage: '512GB', priceModifier: 4200000, stock: 6, sold: 142 },
            { sku: 'IPA13-SG-1TB',  color: 'Space Grey', colorHex: '#5e5d5a', storage: '1TB', priceModifier: 8400000, stock: 18, sold: 92 },

            { sku: 'IPA13-PU-128', color: 'Purple', colorHex: '#b8b5cc', storage: '128GB', priceModifier: 0, stock: 9, sold: 110 },
            { sku: 'IPA13-PU-256', color: 'Purple', colorHex: '#b8b5cc', storage: '256GB', priceModifier: 2100000, stock: 22, sold: 160 },
            { sku: 'IPA13-PU-512', color: 'Purple', colorHex: '#b8b5cc', storage: '512GB', priceModifier: 4200000, stock: 5, sold: 133 },
            { sku: 'IPA13-PU-1TB',  color: 'Purple', colorHex: '#b8b5cc', storage: '1TB', priceModifier: 8400000, stock: 15, sold: 63 },

            { sku: 'IPA13-SL-128', color: 'Starlight', colorHex: '#f0e5d8', storage: '128GB', priceModifier: 0, stock: 11, sold: 121 },
            { sku: 'IPA13-SL-256', color: 'Starlight', colorHex: '#f0e5d8', storage: '256GB', priceModifier: 2100000, stock: 17, sold: 169 },
            { sku: 'IPA13-SL-512', color: 'Starlight', colorHex: '#f0e5d8', storage: '512GB', priceModifier: 4200000, stock: 13, sold: 92 },
            { sku: 'IPA13-SL-1TB',  color: 'Starlight', colorHex: '#f0e5d8', storage: '1TB', priceModifier: 8400000, stock: 7, sold: 65 },
            ],
        description: {
            ...
            specs: ['Garansi: Resmi iBox Official', 'Layar: Liquid Retina 13 inci dengan True Tone', 'Chip: Apple M3', 'Kamera: 12MP Wide di bagian depan dan belakang', 'Konektor: USB-C', 'Koneksi: Wifi Only'  ],
        },
        ...
        cons: ['Tidak memiliki layar ProMotion 120Hz'],
    ...
    // Produk 43 iPad Air 11" M3
    {
        ...
        variants: [
            { sku: 'IPA11-PU-128', color: 'Purple', colorHex: '#b8b5ce', storage: '128GB', priceModifier: 0, stock: 8, sold: 195 },
            { sku: 'IPA11-PU-256', color: 'Purple', colorHex: '#b8b5ce', storage: '256GB', priceModifier: 2100000, stock: 4, sold: 168 },
            { sku: 'IPA11-PU-512', color: 'Purple', colorHex: '#b8b5ce', storage: '512GB', priceModifier: 4200000, stock: 1, sold: 121 },
            { sku: 'IPA11-PU-1TB', color: 'Purple', colorHex: '#b8b5ce', storage: '1TB', priceModifier: 8400000, stock: 0, sold: 98 },
            { sku: 'IPA11-BU-128', color: 'Blue', colorHex: '#a5b8cd', storage: '128GB', priceModifier: 0, stock: 12, sold: 221 },
            { sku: 'IPA11-BU-256', color: 'Blue', colorHex: '#a5b8cd', storage: '256GB', priceModifier: 2100000, stock: 7, sold: 184 },
            { sku: 'IPA11-BU-512', color: 'Blue', colorHex: '#a5b8cd', storage: '512GB', priceModifier: 4200000, stock: 3, sold: 142 },
            { sku: 'IPA11-BU-1TB', color: 'Blue', colorHex: '#a5b8cd', storage: '1TB', priceModifier: 8400000, stock: 1, sold: 77 },
            { sku: 'IPA11-SG-128', color: 'Space Grey', colorHex: '#5e5d5a', storage: '128GB', priceModifier: 0, stock: 14, sold: 180 },
            { sku: 'IPA11-SG-256', color: 'Space Grey', colorHex: '#5e5d5a', storage: '256GB', priceModifier: 2100000, stock: 9, sold: 155 },
            { sku: 'IPA11-SG-512', color: 'Space Grey', colorHex: '#5e5d5a', storage: '512GB', priceModifier: 4200000, stock: 5, sold: 115 },
            { sku: 'IPA11-SG-1TB', color: 'Space Grey', colorHex: '#5e5d5a', storage: '1TB', priceModifier: 8400000, stock: 2, sold: 54 },
            { sku: 'IPA11-SL-128', color: 'Starlight', colorHex: '#f0e5d8', storage: '128GB', priceModifier: 0, stock: 11, sold: 230 },
            { sku: 'IPA11-SL-256', color: 'Starlight', colorHex: '#f0e5d8', storage: '256GB', priceModifier: 2100000, stock: 6, sold: 190 },
            { sku: 'IPA11-SL-512', color: 'Starlight', colorHex: '#f0e5d8', storage: '512GB', priceModifier: 4200000, stock: 3, sold: 109 },
            { sku: 'IPA11-SL-1TB', color: 'Starlight', colorHex: '#f0e5d8', storage: '1TB', priceModifier: 8400000, stock: 1, sold: 131 },
        ],
        description: {
            intro: 'iPad Air baru dengan chip M3 super cepat. Kini hadir dalam dua ukuran portabel, dengan layar Liquid Retina yang memukau dan kemampuan AI terdepan untuk produktivitas dan kreativitas tanpa batas.',
            specs: ['Garansi: Resmi iBox Official','Layar: Liquid Retina 11 inci dengan True Tone', 'Chip: Apple M3', 'Kamera: 12MP Wide di bagian depan dan belakang', 'Konektor: USB-C', 'Koneksi: Wifi Only'  ],
        },
    ...
    // Produk 44 iPad 11th Gen
    {
        ...
        variants: [
            { sku: 'IP11-PI-128', color: 'Pink', colorHex: '#f5d7de', storage: '128GB', priceModifier: 0, stock: 12, sold: 215 },
            { sku: 'IP11-PI-256', color: 'Pink', colorHex: '#f5d7de', storage: '256GB', priceModifier: 1500000, stock: 7, sold: 155 },
            { sku: 'IP11-PI-512', color: 'Pink', colorHex: '#f5d7de', storage: '512GB', priceModifier: 3000000, stock: 3, sold: 121 },
            { sku: 'IP11-BU-128', color: 'Blue', colorHex: '#a5b8cd', storage: '128GB', priceModifier: 0, stock: 15, sold: 199 },
            { sku: 'IP11-BU-256', color: 'Blue', colorHex: '#a5b8cd', storage: '256GB', priceModifier: 1500000, stock: 8, sold: 168 },
            { sku: 'IP11-BU-512', color: 'Blue', colorHex: '#a5b8cd', storage: '512GB', priceModifier: 3000000, stock: 4, sold: 109 },
            { sku: 'IP11-YE-128', color: 'Yellow', colorHex: '#f5e6a8', storage: '128GB', priceModifier: 0, stock: 10, sold: 223 },
            { sku: 'IP11-YE-256', color: 'Yellow', colorHex: '#f5e6a8', storage: '256GB', priceModifier: 1500000, stock: 5, sold: 150 },
            { sku: 'IP11-YE-512', color: 'Yellow', colorHex: '#f5e6a8', storage: '512GB', priceModifier: 3000000, stock: 1, sold: 130 },
            { sku: 'IP11-SI-128', color: 'Silver', colorHex: '#e3e4e6', storage: '128GB', priceModifier: 0, stock: 14, sold: 204 },
            { sku: 'IP11-SI-256', color: 'Silver', colorHex: '#e3e4e6', storage: '256GB', priceModifier: 1500000, stock: 6, sold: 171 },
            { sku: 'IP11-SI-512', color: 'Silver', colorHex: '#e3e4e6', storage: '512GB', priceModifier: 3000000, stock: 2, sold: 112 },
        ],
        description: {
            ...
            specs: [ 'Garansi: Resmi iBox Official','Layar: Liquid Retina 10.9 inci', 'Chip: A16 Bionic', 'Kamera: 12MP Wide di bagian belakang', 'Konektor: USB-C', 'Koneksi: Wifi Only'  ],
        },
        ...
        cons: ['Tidak mendukung Apple Pencil Pro'],
    ...
    // Produk 45 iPad mini 7th Gen
    {
        ...
        variants: [
            { sku: 'IPM7-SL-128', color: 'Starlight', colorHex: '#f0e5d8', storage: '128GB', priceModifier: 0, stock: 11, sold: 205 },
            { sku: 'IPM7-SL-256', color: 'Starlight', colorHex: '#f0e5d8', storage: '256GB', priceModifier: 1500000, stock: 6, sold: 158 },
            { sku: 'IPM7-SL-512', color: 'Starlight', colorHex: '#f0e5d8', storage: '512GB', priceModifier: 3000000, stock: 2, sold: 117 },
            { sku: 'IPM7-BU-128', color: 'Blue', colorHex: '#a5b8cd', storage: '128GB', priceModifier: 0, stock: 14, sold: 220 },
            { sku: 'IPM7-BU-256', color: 'Blue', colorHex: '#a5b8cd', storage: '256GB', priceModifier: 1500000, stock: 9, sold: 169 },
            { sku: 'IPM7-BU-512', color: 'Blue', colorHex: '#a5b8cd', storage: '512GB', priceModifier: 3000000, stock: 4, sold: 125 },
            { sku: 'IPM7-PU-128', color: 'Purple', colorHex: '#b8b5ce', storage: '128GB', priceModifier: 0, stock: 13, sold: 194 },
            { sku: 'IPM7-PU-256', color: 'Purple', colorHex: '#b8b5ce', storage: '256GB', priceModifier: 1500000, stock: 7, sold: 151 },
            { sku: 'IPM7-PU-512', color: 'Purple', colorHex: '#b8b5ce', storage: '512GB', priceModifier: 3000000, stock: 1, sold: 106 },
            { sku: 'IPM7-SG-128', color: 'Space Grey', colorHex: '#5e5d5a', storage: '128GB', priceModifier: 0, stock: 10, sold: 211 },
            { sku: 'IPM7-SG-256', color: 'Space Grey', colorHex: '#5e5d5a', storage: '256GB', priceModifier: 1500000, stock: 5, sold: 170 },
            { sku: 'IPM7-SG-512', color: 'Space Grey', colorHex: '#5e5d5a', storage: '512GB', priceModifier: 3000000, stock: 0, sold: 131 },
        ],
        description: {
            ...
            specs: [ 'Garansi: Resmi iBox Official','Layar: Liquid Retina 8.3 inci', 'Chip: A17 Pro', 'Kamera: 12MP Wide di bagian belakang', 'Fitur: Touch ID di tombol atas', 'Koneksi: Wifi Only'  ],
        },
        ...
        cons: ['Refresh rate layar hanya 60Hz'],
    ...
    // Produk 46 AirPods Max
    {
        ...
        variants: [
            { sku: 'APM-BL', color: 'Blue', colorHex: '#a5b8cd', stock: 8, sold: 172 },
            { sku: 'APM-PU', color: 'Purple', colorHex: '#b8b5ce', stock: 13, sold: 147 },
            { sku: 'APM-MD', color: 'Midnight', colorHex: '#3a3a3d', stock: 15, sold: 92 },
            { sku: 'APM-SL', color: 'Starlight', colorHex: '#f0e5d8', stock: 7, sold: 120 },
            { sku: 'APM-OR', color: 'Orange', colorHex: '#ff8c69', stock: 2, sold: 72 },
        ],
        description: { intro: 'AirPods Max menata ulang headphone over-ear. Audio spasial dengan pelacakan kepala dinamis memberikan suara surround laksana teater untuk film dan acara TV.', specs: ['Garansi: Resmi iBox Official','Audio Spasial Personal', 'Active Noise Cancellation dan mode Transparansi Adaptif', 'Hingga 20 jam waktu dengar'], condition: 'Produk Baru, Garansi Resmi.' },
    ...
    // Produk 47 AirPods Pro 2
    {
        ...
        variants: [
                { sku: 'APP-G2-W', color: 'White', colorHex: '#f5f5f7', stock: 63, sold: 743 }
        ],
        description: { intro: 'AirPods Pro telah direkayasa ulang untuk menghasilkan kualitas audio yang lebih kaya. Peredam Kebisingan Aktif level berikutnya dan Transparansi Adaptif mengurangi lebih banyak suara eksternal.', specs: ['Garansi: Resmi iBox Official','Chip H2 Apple', 'Audio Spasial Personal', 'Casing Pengisian Daya MagSafe (USB-C)'], condition: 'Produk Baru, Garansi Resmi.' },
    ...
    // Produk 48 AirPods 4
    {
        ...
        variants: [
            { sku: 'AP4-NONANC', feature: 'Non-ANC', priceModifier: 0, stock: 73, sold: 423 },
            { sku: 'AP4-ANC', feature: 'Active Noice Cancelation', priceModifier: 800000, stock: 56, sold: 532 }
        ],
        description: { intro: 'Memperkenalkan AirPods (Generasi ke-4) dengan desain baru yang nyaman dan Audio Spasial Personal. Kini hadir dalam dua pilihan: dengan desain universal atau dengan Peredam Kebisingan Aktif untuk pengalaman mendengar yang lebih fokus.', specs: ['Garansi: Resmi iBox Official','Chip H2 Apple', 'Audio Spasial Personal', 'Desain berkontur baru'], condition: 'Produk Baru, Garansi Resmi.' },
    ...
    // produk 49
    {
        ...
        description: {
            ...
            specs: ['Garansi: Resmi iBox Official','Koneksi: Bluetooth, port Lightning', 'Fitur: Tombol Panah Ukuran Penuh, Keypad Numerik'],
    ...
    // Produk 51 Magic Trackpad - Black
    {
        ...
        description: {
            ...
            specs: ['Garansi: Resmi iBox Official','Koneksi: Bluetooth, port Lightning', 'Teknologi: Force Touch, Multi-Touch'],
            condition: 'Produk Baru, Garansi Resmi.'
        },
    ...
    // Produk 53 Magic Keyboard for iPad Pro 13" - Black
    {
        ...
        description: {
            ...
            specs: ['Garansi: Resmi iBox Official','Kompatibilitas: iPad Pro 13 inci (M4)', 'Fitur: Baris fungsi, Trackpad dengan umpan balik haptik', 'Konektor: USB-C untuk pass-through charging'],
        },
        ...
        cons: ['Menambah bobot yang signifikan pada iPad'],
    ...
    // Produk 55 Magic Keyboard for iPad Pro 11" - Black
    {
        ...
        description: {
            ...
            specs: ['Garansi: Resmi iBox Official','Kompatibilitas: iPad Pro 11 inci (M4)', 'Fitur: Baris fungsi, Trackpad dengan umpan balik haptik', 'Konektor: USB-C untuk pass-through charging'],
        },
